...
def main(args):
    ...
    for t in idx:
        ...
        # 2) EE-Überschuss (ohne Handel) hat absolute Priorität
        ...
        # 7) Import-Stack NUR bauen, wenn KEIN EE-Überschuss und Import > 0 und Kopplung
        ...
        # 8) Seitenwahl (mit Preis-Anchor), aber EE-Surplus sticht immer
        if ee_surplus:
            marginal_side  = "DE"
        ...
        results.append({
            ...
            "residual_after_trade_MW": residual,  # hilft beim Debuggen
        })
        debug_rows.append({
            "timestamp": t,
